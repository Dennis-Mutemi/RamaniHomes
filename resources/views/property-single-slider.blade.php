@include('includes/header')
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-8 col-md-8">
                     ...
                     <h6><i class="mdi mdi-home-map-marker"></i> 250-260 3rd St, Hoboken, NJ 07030, USA</h6>
                  </div>
                  <div class="col-lg-4 col-md-4 text-right">
                     <h6 class="mt-2">For Rent</h6>
                     <h2 class="text-primary">$25,000 <small>/month</small></h2>
                  </div>
               </div>
               <hr>
               <div class="row">
                  <div class="col-lg-8 col-md-8">
                     <p class="mt-1 mb-0"><strong>Property ID</strong> : 533566 &nbsp;&nbsp; <strong>Add to favorites</strong> <i class="mdi mdi-heart text-danger"></i></p>
                  </div>
                  <div class="col-lg-4 col-md-4 text-right">
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-3 col-md-3">
                  <h4 class="mb-5 mt-0"><a class="logo" href="index.html"><img src="img/logo.png" alt="osahan logo"></a></h4>
                  ...
                  <p class="mb-0"><a class="text-primary" href="#">www.askbootstrap.com</a></p>
               </div>
      ...
      <section class="pt-4 pb-4 text-center">
         <p class="mt-0 mb-0">© Copyright 2018 <strong class="text-dark">Osahan Property</strong>. All Rights Reserved</p>
         <small class="mt-0 mb-0">
         Made with <i class="mdi mdi-heart text-danger"></i> by <a class="text-primary" target="_blank" href="https://askbootstrap.com/">Ask Bootstrap</a>
         </small>
      </section>
      <!-- End Copyright -->
