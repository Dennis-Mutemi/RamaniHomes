...
<script>
  ...
  gtag('config', 'UA-120909275-1');
      ...
      <title>RamaniHomes</title>
      <!-- Favicon Icon -->
      <link rel="icon" type="assets/image/png" href="{{url('images/favicon.png')}}">
      <!-- Bootstrap core CSS -->
      <link href="{{url('assets/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
      <!-- Material Design Icons -->
      <link href="{{url('assets/vendor/icons/css/materialdesignicons.min.css')}}" media="all" rel="stylesheet" type="text/css" />
      <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
      <!-- Select2 CSS -->
      <link href="{{url('assets/vendor/select2/css/select2-bootstrap.css')}}" />
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-4 col-md-4">
                  <p>
                     Welcome To <strong>Ramani</strong> Homes! 
                  </p>
               </div>
      ...
      <header>
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
               ...
               <img src="img/logo.png" alt="osahan logo">
               </a>
               ...
               <div class="collapse navbar-collapse" id="navbarResponsive">
                  <ul class="navbar-nav mr-auto mt-2 mt-lg-0 margin-auto">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownPortfolio">
                           <a class="dropdown-item" href="properties-grid.html">Ongoing Projects</a>
                           <a class="dropdown-item" href="properties-list.html">Completed Projects</a>
                  ...
                  <div class="my-2 my-lg-0">
                     <ul class="list-inline main-nav-right">
                        <li class="list-inline-item">
                           <a class="btn btn btn-outline-primary btn-sm" href="{{url('login')}}"><i class="mdi mdi-account-outline"></i> Sign In</a>
                        </li>
                        <li class="list-inline-item">
                           <a class="btn btn-primary btn-sm" href="{{url('register')}}"><i class="mdi mdi-account-outline"></i> Sign Up</a>
                        </li>
                     </ul>
                  </div>
               </div>
